...
# N_sample = 1000
mat = scipy.io.loadmat('../../data/observe_x_3d_MC_1000.mat')
...
# Riccati data for comparison
# N_sample = 10000
mat0 = scipy.io.loadmat('../../data/observe_x_3d_10000.mat')
...
# Figure 6 in the appendix of the arxiv paper
import matplotlib
matplotlib.rcParams.update({'font.size': 13})

hf = plt.figure()
ha = hf.add_subplot(111, projection='3d')
ha.scatter(obs0_x[a:b,1], obs0_x[a:b,0], obs0_func[a:b]) # X: time, Y: state
ha.set_xlabel(r'$\xi_2$')
ha.set_ylabel(r'$\xi_1$')
ha.set_title("Riccati")
plt.savefig("../../plots/Riccati_value_function_3d.pdf")
...
plt.savefig("../../plots/PINN_prediction_value_function_3d.pdf")

hf = plt.figure()
ha = hf.add_subplot(111, projection='3d')
ha.scatter(obs0_x[a:b,1], obs0_x[a:b,0], yhat[a:b]-obs0_func[a:b]) # X: time, Y: state
ha.set_xlabel(r'$\xi_2$')
ha.set_ylabel(r'$\xi_1$')
ha.set_title("Difference")
plt.savefig("../../plots/difference_value_function_3d.pdf")
